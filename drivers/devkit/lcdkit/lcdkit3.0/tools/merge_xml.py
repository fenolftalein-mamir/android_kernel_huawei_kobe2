...
def get_plat_name(config_path_name):
    ...
    plat_index = raw_input("Please input plat index(e.g.,1): ")
...
def get_chip_name(chip_path):
    ...
    chip_index = raw_input("Please input chip index(e.g.,1): ")
...
def get_product_name(product_path):
    ...
    product_index = raw_input("Please input product index(e.g.,1): ")
